...
- **A논문 (경북대, 2024)**: Transfer Learning만으로 94.8% 달성했으나 None(정상) 클래스를 제외한 실험
- **B논문 (인하대, 2025)**: 회전 증강 50%로 GM+ 0.9195 달성했으나 Transfer Learning 미적용 -> 회전 증강 100%일 때와 결과 차이가 별로 없음 -> 일정 수준 이상에선 데이터 증강의 효과가 미미
